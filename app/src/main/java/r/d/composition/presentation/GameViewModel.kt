...
import r.d.composition.data.GameRepositoryImpl
...
import r.d.composition.domain.usecases.GeneratedQuestionUseCase
import r.d.composition.domain.usecases.GetGameSettingsUseCase
...
class GameViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val generateQuestionUseCase = GeneratedQuestionUseCase(repository)
